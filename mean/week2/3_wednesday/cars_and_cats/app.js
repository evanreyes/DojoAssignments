...
let server = http.createServer(function (request, response){
    ...
    else if(request.url === '/images/cars/4.jpg'){
        fs.readFile('./images/cars/4.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    ...
    else if(request.url === '/images/cars/5.jpg'){
        fs.readFile('./images/cars/5.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    ...
    else if(request.url === '/images/cats/4.jpg'){
        fs.readFile('./images/cats/4.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    ...
    else if(request.url === '/images/cats/5.jpg'){
        fs.readFile('./images/cats/5.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
